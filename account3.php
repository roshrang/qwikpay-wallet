				...
				<div id="parentVerticalTab">
			     ...
			     <div class="tab-grids">
                    <div id="tab1" class="tab-grid">  
						...
						<form action="setprofile.php" method="post" id="signup">
						<ol>							
							<li>
                                <h4>Enter your Profile Password</h4>
								<input type="password" id="tel" name="profpass" placeholder="Enter Profile Password" required="required" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters">
								<br>
								</li>
								<li>
								 <h4>Re-Enter Profile Password</h4>
								<input type="password" id="tel" name="profcpass" placeholder="Enter Profile Password" required="required" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters">
