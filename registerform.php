...
<div class="agileits-inner-banner">
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			<span class="agile-breadcrumbs"><a href="index.php"><i class="fa fa-home home_1"></i></a> / <span>Registration</span></span>
		</div>
	</div>
		<!-- Bus -->
	...
	<div class="col-md-5 bann-info1">
	 <h3 class="other-nw">
        ...
        <div class="book-a-ticket">
							<div class=" bann-info">
								<form action="register1.php" method="post" id="myForm">
									<div class="ban-top">
										<div class="bnr-left">
											<label class="inputLabel">Enter Name</label>
											  <input type="text" class="form-control" name="usr_nme" placeholder="Name" required="required" />
										</div>
										
										<div class="bnr-left">
											<label class="inputLabel">Enter Email Id</label>
											<input type="email" class="form-control" name="usr_email" id="email" placeholder="Email" required="required" />
										</div>
										<div class="bnr-left">
											<label class="inputLabel">Enter Mobile Number</label>
											<input type="text" title="Only numbers." pattern="[0-9.]+" class="form-control" name="usr_num" id="email" placeholder="Email" required="required" />
										</div>
										<div class="bnr-left">
					...
					if($val==7)
						echo "Incorrect Details Try Register Again";
					if($val==9)
