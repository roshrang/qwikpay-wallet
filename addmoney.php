...
<header>
	...
	<div class="container">
	  ...
	  $stmt1 = $conn->prepare("SELECT usr_crdsve FROM `user_data` WHERE `usr_id`=?");
			   $stmt1->bind_param("i", $user_id); 
      $stmt1->execute();
	  $stmt1->bind_result($usr_crdsve); 
	  $stmt1->fetch();
	  $stmt1->close();
			echo" 
...
<!-- breadcrumbs -->
    ...
    <div class="container">
			<h3 class="w3-head">Card Details</h3>
	<!--Horizontal Tab-->
        <div id="parentHorizontalTab">
            ...
            <div class="resp-tabs-container hor_1">
                <div>
                    <form name="moneyadd" action="money_add.php" method="post" class="creditly-card-form agileinfo_form">
									<section class="creditly-wrapper wthree, w3_agileits_wrapper">
										<div class="credit-card-wrapper">
											<div class="first-row form-group">
												<div class="controls">
													<label class="control-label">Name on Card</label>
													<input class="billing-address-name form-control" type="text" name="card_name" placeholder="John Smith">
												</div>
												...
												<div class="controls">
													...
													<input class="expiration-month-and-year form-control" type="text" name="exp_date" placeholder="MMYY">
												</div>
												<div class="controls">
													<label class="control-label">Amount</label>
													<input  class="billing-address-name form-control" type="text" name="amt">
												</div>
												<input type="hidden" name="option" value="1">
											<input type="checkbox" name="save_card" value="true"><b><font color="#000">Save this card to your profile<br></font>
											<?php if($usr_crdsve<>0)
											{
												//echo "entered";
												?>
											...
											<button type="submit" class="submit btn btn-primary btn-sm"><span>Make a payment <i class="fa fa-long-arrow-right" aria-hidden="true"></i></span></button>								
										</div>
									</section>
								</form>
<!-- credit-card -->
