...
<div class="categories-section main-grid-border" id="mobilew3layouts">
	...
	<div>
                    ...
                    <div id="tab2" class="tab-grid">
						...
						<form action="transferpay1.php" method="get" id="signup">
						<ol>	
                            <li>
	 ...
	 ?>
							...
							<h3>Transferring Amount Euro <?php echo $mvalue;?></h3>
                            <li>
                              <h5>Enter Profile Password To confirm transaction:</h5><br>
						<input id="field_pwd1" title="Password must contain at least 8 characters, including UPPER/lowercase and numbers." type="password" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" name="pwd3"/>
                            ...
                            <li>
							<input type="hidden" id="customer" name="moneyvalue" value=<?php echo$mvalue; ?>>
							<input type="hidden" id="customer" name="wallet_number" value=<?php echo$suser_num; ?>>
							<input type="hidden" id="customer" name="rndmnum" value=<?php echo$frndmnum; ?>>
                              <button type="submit" class="submit btn btn-primary btn-sm">Submit</button>
                            </li>
				        </ol>
