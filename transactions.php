...
<div class="agileits-inner-banner">
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			<span class="agile-breadcrumbs"><a href="index.php"><i class="fa fa-home home_1"></i></a> / <a href="account.php"><span>Account</span></a>/ <span>My Transactions</span></span>
		</div>
	</div>
	...
	<!--bus-single --> 
            <div class="w3agile single-bus">
			         <h3 class="w3-head">Transaction Details</h3>
			 <!-- train-routes -->
					<div class="bus-tp">
				...
				<?php
$stmt = $conn->prepare("SELECT `trn_id`,`trn_des`,`trn_amt`,`trn_sts`,`trn_date` FROM `transaction_details` WHERE `trn_usr_id`=?");
...
if (!$stmt->store_result()) {
 ...
 <div class="w3agile bus-midd">
		   ...
		   <tbody>
		   <?php
$stmt->bind_result($trs_id,$trs_des,$trs_amt,$trs_st,$trs_date);
$stmt->store_result(); 
		  while($row = $stmt->fetch())
		  {
        ?>
		     <tr>
			    <td class="t-one">QwikPay2171217<?php echo $trs_id; ?></td> 
			    <td class="wthree"><i class="glyphicon glyphicon-folder-open" aria-hidden="true"></i><?php echo $trs_des; ?></td>
 				<td class="wthree"><i class="glyphicon glyphicon-eur"></i><?php echo $trs_amt; ?> </td> 
				<td class="wthree"><i class="glyphicon glyphicon-ok"></i><?php echo $trs_st; ?></td> 
				<td class="wthree"><i class="fa fa-clock-o"></i><?php echo substr($trs_date, 0, 10); ?></td>
			 </tr>
			 <?php
		  }
	 }
