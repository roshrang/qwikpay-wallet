	       ...
	       <form action="save_profile.php" method="post">
					...
					<?php
											...
											{											  
											  //$stmt1->fetch();
											  //$stmt1->close();
											  $para="pay_save_card".$val;
											  $val++;
											  ?>
											  
											   <input type="checkbox" name=<?php echo $para;?> value=<?php echo $sv_id;?> ><font color="#000">You have your card saved want to add from it?<?php echo $sv_num;?><br></font>
											  <?php
											}
											if($val==0) echo "<b>No Card Saved</b>";
												?>
						...
						<input type="hidden" name="cval" value=<?php echo $val;?>/>
